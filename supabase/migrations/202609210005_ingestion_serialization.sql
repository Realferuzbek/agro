...
drop function if exists public.ingest_and_recalculate(uuid,text,text,text,timestamptz,text,jsonb,jsonb,bigint,jsonb,jsonb);
...
declare device public.devices; field_row public.fields; current_row public.product_state; receipt jsonb; calc_id uuid; next_revision bigint; previous_observed_at timestamptz;
begin
